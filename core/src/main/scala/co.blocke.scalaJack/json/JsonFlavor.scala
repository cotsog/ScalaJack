...
trait JsonJackFlavor extends JackFlavor[String] {
	...
	class JsonReadRenderer() extends ReadRenderer {
		...
		private def _render[T](
			...
			instance : T, 
			buf      : StringBuilder,
			subType  : LinkedHashMap[String,AType] = LinkedHashMap.empty[String,AType]  // i.e. type of parameterized case class wrapped in a trait (for rendering the hint)
			...
			graph match {
				...
				case g:CCType  => 
					...
					g.superTrait.map( superTrait => {
						val hintValue = {
							val subs = subType.map{ case (label,atype) => vc.hintValueRender.get(superTrait.name).map(_(atype.name)).getOrElse(atype.name) }.mkString("[",",","]")
							if( subs == "[]" )
								vc.hintValueRender.get(superTrait.name).map(_(g.name)).getOrElse(g.name)
							else
								vc.hintValueRender.get(superTrait.name).map(_(g.name)).getOrElse(g.name) + subs
						}
					...
					g.members.foreach( { case(fname, (ftype,defaultVal)) => {
						...
						if( _render(ftype, targetField.get(instance), sb3) ) { 
							sb3.append(",")
							sb2.append(sb3)
						}
					}})
				...
				case g:CollType =>
					g.name match {
						case "scala.Option" => 
							...
							optVal.map( ov => _render(g.colTypes.head, ov, buf) )
							optVal.isDefined
						case n if(n.endsWith("Map")) => 
							...
							if( !mapVal.isEmpty ) 
								mapVal.map({ case (k,v) => {
									...
									if( !vc.isCanonical ) 
										renderedKey = _render(g.colTypes(0), k, sb3)
						...
						case t if( t startsWith("scala.Tuple") ) => 
							...
							arity match {
								case 2  => 
									...
									_render(g.colTypes(0), iv._1, buf)
									buf.append(",")
									_render(g.colTypes(1), iv._2, buf)
								case 3  => 
									...
									_render(g.colTypes(1), iv._2, buf)
									buf.append(",")
									_render(g.colTypes(2), iv._3, buf)
								case 4  => 
									...
									_render(g.colTypes(2), iv._3, buf)
									buf.append(",")
									_render(g.colTypes(3), iv._4, buf)
								case 5  => 
									...
									_render(g.colTypes(3), iv._4, buf)
									buf.append(",")
									_render(g.colTypes(4), iv._5, buf)
								case 6  => 
									...
									_render(g.colTypes(4), iv._5, buf)
									buf.append(",")
									_render(g.colTypes(5), iv._6, buf)
								case 7  => 
									...
									_render(g.colTypes(5), iv._6, buf)
									buf.append(",")
									_render(g.colTypes(6), iv._7, buf)
								case 8  =>
									...
									_render(g.colTypes(5), iv._6, buf)
									buf.append(",")
									_render(g.colTypes(6), iv._7, buf)								// case 9  => 
									buf.append(",")
									_render(g.colTypes(7), iv._8, buf)
								case 9  => 
									...
									_render(g.colTypes(7), iv._8, buf)
									buf.append(",")
									_render(g.colTypes(8), iv._9, buf)
								case 10 => 
									...
									_render(g.colTypes(8), iv._9, buf)
									buf.append(",")
									_render(g.colTypes(9), iv._10, buf)
								case 11 => 
									...
									_render(g.colTypes(9), iv._10, buf)
									buf.append(",")
									_render(g.colTypes(10), iv._11, buf)
								case 12 => 
									...
									_render(g.colTypes(10), iv._11, buf)
									buf.append(",")
									_render(g.colTypes(11), iv._12, buf)
								case 13 => 
									...
									_render(g.colTypes(11), iv._12, buf)
									buf.append(",")
									_render(g.colTypes(12), iv._13, buf)
								case 14 => 
									...
									_render(g.colTypes(12), iv._13, buf)
									buf.append(",")
									_render(g.colTypes(13), iv._14, buf)
								case 15 => 
									...
									_render(g.colTypes(13), iv._14, buf)
									buf.append(",")
									_render(g.colTypes(14), iv._15, buf)
								case 16 => 
									...
									_render(g.colTypes(14), iv._15, buf)
									buf.append(",")
									_render(g.colTypes(15), iv._16, buf)
								case 17 => 
									...
									_render(g.colTypes(15), iv._16, buf)
									buf.append(",")
									_render(g.colTypes(16), iv._17, buf)
								case 18 => 
									...
									_render(g.colTypes(16), iv._17, buf)
									buf.append(",")
									_render(g.colTypes(17), iv._18, buf)
								case 19 => 
									...
									_render(g.colTypes(17), iv._18, buf)
									buf.append(",")
									_render(g.colTypes(18), iv._19, buf)
								case 20 => 
									...
									_render(g.colTypes(18), iv._19, buf)
									buf.append(",")
									_render(g.colTypes(19), iv._20, buf)
								case 21 => 
									...
									_render(g.colTypes(19), iv._20, buf)
									buf.append(",")
									_render(g.colTypes(20), iv._21, buf)
								case 22 => 
									...
									_render(g.colTypes(20), iv._21, buf)
									buf.append(",")
									_render(g.colTypes(21), iv._22, buf)
							}
							buf.append("]")
							true
						case _ => 
							...
							if( !collVal.isEmpty ) {
								collVal.map( item => {
									if( _render(g.colTypes.head, item, buf) )
										buf.append(",")
								})
								if( buf.charAt(buf.length-1) == ',' )
									buf.deleteCharAt(buf.length-1)
				...
				case g:TraitType => 
					...
					_render(cc.copy(superTrait=Some(g)),instance,buf)
				case g:ValueClassType =>
					...
					vc.valClassHandlers.get("default").flatMap( _.get(g.name).map( vcHand => {
							...
							Some(_render(g.vcType,renderVal,buf))
						).get
				case g:EnumType =>
					buf.append(s""""${instance.toString}"""") //"
					true
				case g:DeferredType =>
					val resolved = instance.asInstanceOf[DeferredInstance[_]]
					_render(resolved.specificType, resolved.wrapped, buf, resolved.specificType.paramMap)
					true
				case g:CustomType =>
